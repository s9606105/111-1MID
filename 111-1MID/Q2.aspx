...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            聯絡方式:
            <asp:RadioButtonList ID="rbl_Phone" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" AutoPostBack="true" OnTextChanged="rbl_Phone_TextChanged">
            ...
            <br /><br />
            縣市與區域:
            <asp:DropDownList ID="dpl_City" runat="server" AutoPostBack="true" OnTextChanged="dpl_City_TextChanged"></asp:DropDownList>
